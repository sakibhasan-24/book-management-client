...
export default function Orders() {
  ...
  const { loading, error, getOrdersById } = useOrders();
    ...
    <div className="w-full p-4 sm:max-w-6xl mx-auto my-12 ">
      <div>
        ...
        <section className="flex">
          <div className="flex-1 basis-[60%]">
            <div className="my-4 ">
              ...
              <div className="my-4">
                ...
                <p
                  className={`my-6 w-1/4 px-3 py-2 text-md font-bold rounded-lg ${
                    order.isPaid
          ...
          <div className="flex-1 w-full basis-[30%] h-[300px] shadow-2xl shadow-slate-400 rounded-lg p-4 bg-white">
